...
function initLogger(appName, options) {
    var transports = (options === null || options === void 0 ? void 0 : options.environments) ? helpers_1.getTransports(appName, options.environments, true)
        : helpers_1.getTransports(appName, configs_1.rawJSONConsoleConfig());
    logger = helpers_1.newLogger(appName, transports);
}
